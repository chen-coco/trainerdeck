...
0.7.1 修复了《黎明行者之血》的位置控件识别：保存和传送位置使用下拉菜单；支持填写新名称的控件可选择“新建位置…”后输入名称。新增或删除位置后，列表跟随原修改器同步；“瞬移到标记位置”只显示“应用”按钮。升级后请退出并重新启动游戏和修改器，以加载新版 Bridge。
...
当前版本对应 `release/TrainerDeck-0.7.1.zip`。
